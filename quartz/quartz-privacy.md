...
This privacy policy is applicable to the Bento app (hereinafter referred to as "Application") for mobile devices, which was developed by Developer (hereinafter referred to as "Service Provider") as a a Freemium service. This service is provided "AS IS".
